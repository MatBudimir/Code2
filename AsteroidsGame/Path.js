...
(function (AsteroidsGame) {
    ...
    function createPaths() {
        AsteroidsGame.asteroidPaths = createAsteroidPaths(AsteroidsGame.shapesAsteroids);
        AsteroidsGame.ufoPath = createUfoPath();
    }
    AsteroidsGame.createPaths = createPaths;
