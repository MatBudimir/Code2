...
(function (AsteroidGame) {
    ...
    function createPaths() {
        AsteroidGame.asteroidPaths = createAsteroidPaths(AsteroidGame.shapesAsteroids);
        AsteroidGame.ufoPath = createUfoPath();
    }
    AsteroidGame.createPaths = createPaths;
